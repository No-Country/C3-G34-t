    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //### Acá debería ir UsuarioBase en lugar de Auditor, pero no toma la prop matricula
                var user = new Auditor
                {
                ...
                //var user = new UsuarioBase { UserName = Input.Email, Email = Input.Email };
